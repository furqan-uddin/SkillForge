        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                <div
                  className={`p-3 rounded-full mb-4 ${getButtonClasses(
                    tool.color
                  )} text-white`}
                >
                ...
                <button
                  ...
                  className={`mt-auto flex items-center gap-2 px-5 py-2 text-white rounded-full shadow-md transition ${getButtonClasses(
                    tool.color
                  )}`}
                >
