...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!isValidEmail(formData.email)) {
            toast.error("Please enter a valid email address from the @gmail.com domain.");
            return;
        }
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <div className="relative mt-1">
                            ...
                            />
                            <User className="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-500 dark:text-gray-400" size={20} />
                        </div>
                    </div>
