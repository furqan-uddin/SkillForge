...
const features = [
  {
    ...
    description:
      "Upload your resume and let AI analyze strengths and weaknesses instantly.",
    icon: FileText,
  ...
  },
  {
    name: "AI Roadmap",
    description:
      "Get a personalized career roadmap tailored to your interests and skills.",
    icon: Bot,
    link: "/ai-roadmap",
  },
  {
    name: "JD Matcher",
    description:
      "See how well your resume matches job descriptions and missing keywords.",
    icon: Tally4,
    link: "/jd-matcher",
  },
  {
    ...
    description:
      "Identify missing skills based on your resume and career interests.",
    icon: Layers,
    link: "/skill-gap",
  },
  {
...
const howItWorks = [
  {
    step: "Profile Setup",
    description: "Add your details, resume, and career interests.",
    icon: User,
  },
  {
    step: "AI Career Hub",
    description: "Get roadmaps, track progress, and receive AI insights.",
    icon: Brain,
  },
  {
    step: "Preparation Tools",
    description: "Use JD Matcher, Interview Prep, and Skill Gap Analyzer.",
    icon: Target,
  },
];
...
const whyUs = [
  {
    ...
    description:
      "Our AI creates a unique roadmap tailored to your specific goals and skills.",
    icon: Sparkles,
  },
  {
    title: "Real-time Feedback",
    description:
      "Get instant, actionable insights on your resume, skills, and interview performance.",
    icon: Zap,
  },
  {
    title: "Career-Focused",
    description:
      "Every tool is designed to help you land your next role and advance your career.",
    icon: Briefcase,
  },
];
...
const testimonials = [
  {
    quote:
      "SkillForge helped me prepare for my dream SDE role. The AI Interview Prep was a game-changer!",
    author: "Student User",
  },
  {
    quote:
      "Finally a tool that connects my resume, skills, and goals into one seamless platform.",
        ...
        <div className="relative max-w-7xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-500 to-pink-500 animate-gradient mt-2">
                AI-Powered Guidance
              </span>
            </h1>
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-xl mx-auto lg:mx-0">
              SkillForge offers personalized AI tools for career roadmapping,
              resume optimization, skill gap analysis, and interview
              preparation.
            </p>
      ...
      <section className="bg-gray-50 dark:bg-gray-950 max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {testimonials.map((t, i) => (
            ...
            >
              <p className="italic text-gray-700 dark:text-gray-300 mb-4 text-lg">
                “{t.quote}”
              </p>
      ...
      <section className="relative py-20">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center text-white">
          ...
          <p className="mb-8 text-lg">
            Join SkillForge today and unlock AI-powered tools to transform your
